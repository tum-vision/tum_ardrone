#pragma once
/*
 * EKF implementation for AR.Drone, including scale estimation. & time synchronization.
 * see Camera-Based Navigation of a Low-Cost Quadrocopter (J. Engel, J. Sturm, D. Cremers)
